...
<div class="erp-order-list">
    <div class="form mb20">
        <form action="<?= yii\helpers\Url::to(['/floreas/index'])?>" method="get" class="form-inline">
            <div class="mb10">
...
<!--                </th>-->
            ...
            <?php foreach ($rows as $value) { ?>
                <tr class="first" style="border: 1px solid black">
                    ...
                    <td class="align-right" style="border: 1px solid black">
                        <?php echo isset($charge[$value['memberID']]) ? $charge[$value['memberID']] : 0  ?>
                    </td>
                    <td class="align-right" style="border: 1px solid black">
                        <?php
                        $rank = $value['rank'];
                    ...
                    <td class="align-right" style="border: 1px solid black">
                        <?= Html::a('查看', ['floreas/info','id' => $value['id']],['class' => 'btn btn-primary btn-info']) ?>
                    </td>
                    <td class="align-right" style="border: 1px solid black">
                        <?= Html::a('查看', ['floreas/catch','id' => $value['id']],['class' => 'btn btn-primary btn-info']) ?>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
