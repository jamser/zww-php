...
namespace api\modules\socket\models;;
 ...
 */
class TDoll extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['quantity', 'price', 'redeem_coins', 'created_by', 'modified_by', 'watching_number', 'timeout'], 'integer'],
            ...
            [['machine_url', 'tbimg_context_path', 'rtmp_url_1', 'rtmp_url_2', 'rtmp_url_3'], 'string', 'max' => 100],
            [['tbimg_file_name'], 'string', 'max' => 125],
            [['rtmp_push_url'], 'string', 'max' => 200],
            [['mns_topic_name'], 'string', 'max' => 20],
