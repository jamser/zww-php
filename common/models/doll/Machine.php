 ...
 * @property integer $quantity 数量
 * @property string $price 价格
 * @property integer $redeem_coins 兑换币
 * @property string $machine_status 机器状态
 * @property string $machine_serial_num 机器编号
 * @property string $machine_ip 机器IP
 * @property string $machine_url 机器URL
