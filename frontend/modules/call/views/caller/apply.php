...
$callerName = Setting::getValueByKey('callerName');
$this->title = '申请成为'.$callerName;
$this->params['bodyCssClass'] = 'gray-bg';
?>
<div class="call-caller-apply">
    ...
    <div class="form-group">
        <div class="weui-cell weui-cell_vcode">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" type="tel" placeholder="请输入手机号" id="phone" name="data[phone]" value="<?=$form->phone?>" />
            </div>
            <div class="weui-cell__ft">
                <button class="weui-vcode-btn" type="button" id="btn_get_code">获取验证码</button>
            </div>
        </div>
        <div class="weui-cells__tips red"><?=$form->getFirstError('phone')?></div>
        
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label">验证码</label></div>
            <div class="weui-cell__bd">
                <input class="weui-input" type="text" placeholder="请输入验证码" name="data[code]" value="<?=$form->code?>">
            </div>
        </div>
        <div class="weui-cells__tips red"><?=$form->getFirstError('code')?></div>
