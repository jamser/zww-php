 ...
 **/
var FlashMsg = {
    template:'<div class="alert" id="login_dialog" role="alert" style="position:fixed;width:60%;max-width:600px;top:100px;z-index:999;left:0;right:0;margin:0 auto;"></div>',
    typeCssClass:{
        info:'alert-info',
        error:'alert-danger',
    ...
    error:function(msg, time) {
        ...
        if(msg==='该操作需要登录') {
            if(typeof Zepto !== 'undefined') {//手机
                $('#login_alert').removeClass('hidden');
                return;
            } else if(typeof jQuery !== 'undefined') {//电脑
    ...
    render:function(msg, type, time) {
        ...
        ele.text(msg).addClass(this.typeCssClass[type]).show();
