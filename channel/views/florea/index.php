...
<div class="erp-order-list">
    <div class="form mb20">
        <form action="<?= yii\helpers\Url::to(['/florea/index'])?>" method="get" class="form-inline">
            <div class="mb10">
        ...
        <table class="table table-bordered table-striped table-hover" style="border: 1px solid black">
            ...
            <?php foreach ($rows as $value) { ?>
                <tr class="first" style="border: 1px solid black">
                    ...
                    <td class="align-right" style="border: 1px solid black">
                        <?= Html::a('查看', ['florea/info','id' => $value['id']],['class' => 'btn btn-primary btn-info']) ?>
                    </td>
                    <td class="align-right" style="border: 1px solid black">
                        <?= Html::a('查看', ['florea/catch','id' => $value['id']],['class' => 'btn btn-primary btn-info']) ?>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
...
<script>
    ...
    function chk(){
        var url = "/florea/index?export=on";
