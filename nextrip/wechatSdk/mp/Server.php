...
class Server {
    ...
    protected function prepareInput() {
        ...
        $xmlInput = !empty($GLOBALS['HTTP_RAW_POST_DATA']) ? $GLOBALS['HTTP_RAW_POST_DATA'] : file_get_contents('php://input');
        ...
        if (!empty($_REQUEST['encrypt_type']) && $_REQUEST['encrypt_type'] === 'aes'
            ...
            $input = $this->getCrypt()->decryptMsg(
                    $_REQUEST['msg_signature'], $_REQUEST['nonce'], $_REQUEST['timestamp'], $xmlInput
            );
        }
