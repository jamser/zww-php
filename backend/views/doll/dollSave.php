        ...
        <div id="pad-wrapper" class="new-user">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        <form class="new_user_form inline-input" action="?r=doll/save_do" method="post" enctype="multipart/form-data"/>
                        <input type="hidden" name="stu_id" value="<?php echo $data['id']?>">
                        <div class="span12 field-box">
                            <label>娃娃名称：</label>
                            <input class="span9" type="text" name="dollName" value="<?php echo $data['dollName']?>"/>
                        </div>
                        <div class="span12 field-box">
                            <label>娃娃总量：</label>
                            <input class="span9" type="text" name="dollTotal" value="<?php echo $data['dollTotal']?>"/>
                        </div>
                        <div class="span12 field-box">
                            <label>娃娃图片：</label>
                            <img src="<?php echo "../../common/upload/".$data['img'] ?>" width="100">
                            <input class="span9" type="hidden" name="song_img" value="<?php echo $data['img'] ?>"/>
                        </div>
                        <div class="span12 field-box">
                            <label>选择图片：</label>
                        ...
                        <div class="span12 field-box">
                            <label>娃娃数量：</label>
                            <input class="span9" type="text" name="dollNumber" value="<?php echo $data['dollNumber']?>"/>
                        </div>
                        <div class="span12 field-box">
                            <label>娃娃编号：</label>
                            <input class="span9" type="text" name="dollCode" value="<?php echo $data['dollCode']?>"/>
                        </div>
